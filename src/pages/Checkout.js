...
const Checkout = () => {
   ...
   const checkOutHandler = async () => {
      ...
      const options = {
         key: "rzp_test_jhcFgwnMlBYMps", // Enter the Key ID generated from the Dashboard
         amount: amount,
         currency: currency,
         name: "F-Digitic",
            ...
            <div className="row">
               <div className="col-7">
                  <div className="checkout-left-data">
                     ...
                     <p className="user-details total">Huan Minh (huannvm2002@gmail.com)</p>
                     ...
                     <form
                        ...
                        <div className='w-100'>
                           ...
                           >
                              ...
                              <option value="TPHoChiMinh">TP Ho Chi Minh</option>
                           </select>
